...
public class GraficarArbol extends JPanel { 
    private Proyecto_01.Nodo raiz;        //almacena la raiz del arbol

        //constructor para la raiz del arbol
    public GraficarArbol(Proyecto_01.Nodo raiz) {
        this.raiz = raiz;
    }
    ...
    private void dibujarNodo(Graphics g, Proyecto_01.Nodo nodo, int x, int y, int offset) {
    ...
    public static void mostrarArbolGrafico(Proyecto_01.Nodo raiz) {
